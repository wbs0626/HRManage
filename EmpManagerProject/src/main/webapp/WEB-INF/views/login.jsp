	...
	<div class="container">
		<div class="card card-login mx-auto mt-5">
			<div class="card-header">
				<img src="resources/img/logo.png" style="max-width: 100%; height: auto;">
			</div>
			<div class="card-body">
				<form id="loginFrm" name="loginFrm">
					<div class="form-group">
						<div class="form-label-group">
							<input type="text" id="id" name="id" class="form-control" placeholder="아이디를 입력하세요" required="required" autofocus="autofocus"> <label
								for="id">사용자 ID</label>
						</div>
					</div>
					<div class="form-group">
						<div class="form-label-group">
							<input type="password" id="pwd" name="pwd" class="form-control" placeholder="Password" required="required"> <label for="pwd">비밀번호</label>
						</div>
					</div>
	...
	<script type="text/javascript">
		$(function() {
			$('#logBtn').click(function() {
				...
				/* var idTypeChk =  /^[A-Za-z0-9+]{4,20}$/;
				var pwdTypeChk =  /^[0-9+]{4,20}$/;
				
				
				if (idTypeChk.test(id)) {
					alert('잘못된 아이디입니다.'); 
				} else if (pwdTypeChk.test(pwd)) {
